...
public class WorkingUnitTests {
    ...
    public void emailShouldBelongToDomain(){
        try {
            ...
            assertEquals(ErrorConstants.CODE_UD_01.getValue(), userDemoError.getMessage());
            assertEquals(ErrorConstants.CODE_UD_01.name(), userDemoError.getCode());
        }
    }
    ...
    public void phoneNumberShouldBelongToColombia(){
        try {
            ...
            assertNotNull(e.getError());
            UserDemoError userDemoError = e.getError();
            assertEquals(ErrorConstants.CODE_UD_02.getValue(), userDemoError.getMessage());
            assertEquals(ErrorConstants.CODE_UD_02.name(), userDemoError.getCode());
        }
    }
